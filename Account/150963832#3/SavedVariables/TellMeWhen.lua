	...
	["global"] = {
		["TextLayouts"] = {
			...
			["TMW:textlayout:1OB73nbt3va_"] = {
				...
				["GUID"] = "TMW:textlayout:1OB73nbt3va_",
				["Name"] = "冷却",
				["n"] = 2,
			},
			...
			["TMW:textlayout:1O7BIcLj1lWL"] = {
				...
				["GUID"] = "TMW:textlayout:1O7BIcLj1lWL",
				["Name"] = "以万为单位",
			},
			["TMW:textlayout:1O7COAsJADtW"] = {
				{
					["Anchors"] = {
						{
							["point"] = "BOTTOMRIGHT",
				...
				["GUID"] = "TMW:textlayout:1O7COAsJADtW",
				["Name"] = "显示层数",
				["n"] = 2,
			},
			...
			["TMW:textlayout:1PIY0TA8GANp"] = {
				...
				["GUID"] = "TMW:textlayout:1PIY0TA8GANp",
				["Name"] = "百分比监视",
				["n"] = 2,
			},
			...
			["TMW:textlayout:1OzSkjQjupIc"] = {
				...
				["GUID"] = "TMW:textlayout:1OzSkjQjupIc",
				["Name"] = "M艾萨拉",
				["n"] = 2,
			},
			["TMW:textlayout:1O4adRDUKGTK"] = {
				{
					["Anchors"] = {
						{
							["x"] = 3,
				...
				["GUID"] = "TMW:textlayout:1O4adRDUKGTK",
				["Name"] = "buff数值",
				["n"] = 3,
			},
			["icon1"] = {
			...
			["TMW:textlayout:1NaZ=cmnWDS8"] = {
				...
				["GUID"] = "TMW:textlayout:1NaZ=cmnWDS8",
				["Name"] = "计量条显示样式 2",
				["n"] = 3,
			},
		...
		["CodeSnippets"] = {
			{
				["Order"] = 2,
				["Name"] = "CircleTag",
				["Code"] = "local DogTag = LibStub(\"LibDogTag-3.0\")\nlocal L = DogTag.L\n\nDogTag:AddTag(\"Unit\", \"Circle\", {\n        code = TMW.CNDT.Env.Circle,\n        arg = {},\n        ret = \"number\",\n        events = \"Update\",\n        doc = L[\"Return the total number of units in distance\"],\n        example = '[Circle()] => \"2\"',\n        category = L[\"Auras\"]\n})",
			}, -- [1]
			{
				["Name"] = "Circle",
				["Code"] = "local TMW = TMW\nlocal CNDT = TMW.CNDT\nlocal Env = TMW.CNDT.Env\nfunction Env.Circle()\n    local count = 0\n    for i = 1, 40 do\n        local unit = \"nameplate\" .. i\n        if UnitCanAttack(\"player\", unit) and IsItemInRange(63427,unit)  then count = count + 1 end\n    end \n    local start=1\n    for j=1,count do\n        start = start * 0.97\n    end\n    start = max(start,0.5)\n    local ed = (getIntPart((1 - start)*10000))/100\n    return ed..\"%\"\n    \nend\n\nfunction getIntPart(x)\n    if x <= 0 then\n        return math.ceil(x);\n    end\n    \n    if math.ceil(x) == x then\n        x = math.ceil(x);\n    else\n        x = math.ceil(x) - 1;\n    end\n    return x;\nend",
			}, -- [2]
			["n"] = 2,
		},
		...
		["Groups"] = {
			{
				["GUID"] = "TMW:group:1OuknztzC_wy",
				["Scale"] = 1.65438079833984,
				["Rows"] = 2,
				["Columns"] = 7,
				["Icons"] = {
					{
			...
			{
				["GUID"] = "TMW:group:1QLlc_9TbZsd",
				["Scale"] = 1.15598845481873,
				["Columns"] = 11,
				["Icons"] = {
					{
						["ShowTimer"] = true,
						...
						["Events"] = {
							{
								["Type"] = "Announcements",
								["Channel"] = "YELL",
								["Text"] = "成功打断 [Unit:Name] 的 [CastName(unit='target')]",
								["Event"] = "OnCLEUEvent",
							}, -- [1]
							["n"] = 1,
						},
						...
						["Events"] = {
							{
								["Type"] = "Announcements",
								["Channel"] = "YELL",
								["Text"] = "成功驱散 [Unit:Name] 的 [CastName(unit='target')]",
								["Event"] = "OnCLEUEvent",
							}, -- [1]
							["n"] = 1,
						},
			...
			}, -- [2]
			{
				...
				["Scale"] = 0.864935576915741,
				["Rows"] = 15,
				["TextureName"] = "YaSkada04",
				["Level"] = 5,
				["Enabled"] = false,
				["Columns"] = 2,
				["Icons"] = {
					...
					}, -- [2]
					{
						...
						["SettingsPerView"] = {
							["bar"] = {
								["Texts"] = {
									"[ArmorRating]/[ArmorReduction(113):Round(2)]%", -- [1]
									"护甲/减免：", -- [2]
								},
							},
						},
					...
					}, -- [4]
					{
						["Type"] = "meta",
						["Icons"] = {
							"TMW:icon:1SNMRcdShEt=", -- [1]
							"TMW:icon:1SNMRciPeZFT", -- [2]
							"TMW:icon:1SNMRcie0BDm", -- [3]
						},
						["States"] = {
							{
							}, -- [1]
					...
					}, -- [8]
					{
						["Type"] = "meta",
						["Icons"] = {
							"TMW:icon:1NzpC=7gs8qq", -- [1]
							"TMW:icon:1NzpC=8HGbvH", -- [2]
						},
						["BackdropColor"] = "00000000",
						["States"] = {
							{
					...
					}, -- [18]
					{
						...
						["SettingsPerView"] = {
							["bar"] = {
								["Texts"] = {
									"[Versatility:Round(2)]%/[(Versatility / 2):Round(2)]%", -- [1]
									"全能：", -- [2]
								},
							},
						},
					...
					}, -- [28]
					{
						["Type"] = "meta",
						["Icons"] = {
							"TMW:icon:1NzptU7D8YtM", -- [1]
							"TMW:icon:1NzptU7Xennv", -- [2]
						},
						["States"] = {
							{
							}, -- [1]
			...
			}, -- [3]
			{
				...
				["Icons"] = {
					...
					}, -- [5]
					{
						["Type"] = "buff",
						["ShowTTText"] = true,
						["Name"] = "321197; 331535; 329429",
						["SettingsPerView"] = {
							["icon"] = {
								["TextLayout"] = "TMW:textlayout:1O7BIcLj1lWL",
							},
						},
						["States"] = {
							{
					...
					}, -- [7]
					{
						["Type"] = "buff",
						["ShowTTText"] = true,
						["Name"] = "17; 209388; 235313; 315763",
						["SettingsPerView"] = {
							["icon"] = {
								["TextLayout"] = "TMW:textlayout:1NbYD68cX799",
								["Texts"] = {
									"[Floor(Stacks:Hide(0))]", -- [1]
									"", -- [2]
								},
							},
						},
				...
				["Icons"] = {
					{
						...
						["SettingsPerView"] = {
							["icon"] = {
								["TextLayout"] = "icon2",
								["Texts"] = {
									"[Timer(\"combat\"):FormatDuration:Cyan]", -- [1]
									"", -- [2]
								},
							},
							["bar"] = {
								["TextLayout"] = "TMW:textlayout:1NaZ=cmnWDS8",
								["Texts"] = {
									"", -- [1]
									"", -- [2]
									"[Timer(\"combat\"):FormatDuration]", -- [3]
								},
							},
						},
						["CustomTex"] = "none",
