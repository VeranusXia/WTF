	...
	["profiles"] = {
		["Default"] = {
			...
			["bags"] = {
				...
				["countFontSize"] = 11,
				["itemInfoFontOutline"] = "THICKOUTLINE",
				["vendorGrays"] = {
					["enable"] = true,
				},
			...
			["movers"] = {
				...
				["RaidMarkerBarAnchor"] = "BOTTOM,ElvUIParent,BOTTOM,0,82",
				["ElvUF_PlayerCastbarMover"] = "BOTTOM,ElvUIParent,BOTTOM,0,128",
				["ElvUF_RaidMover"] = "TOPRIGHT,ElvUIParent,BOTTOMLEFT,741,494",
				...
				["BossButton"] = "TOP,ElvUIParent,TOP,222,-444",
				["LootFrameMover"] = "TOP,ElvUIParent,TOP,270,-528",
				["SocialMenuMover"] = "BOTTOMLEFT,ElvUIParent,BOTTOMLEFT,3,243",
			...
			["unitframe"] = {
				...
				["units"] = {
					...
					["raid"] = {
						...
						["height"] = 35,
						["visibility"] = "[nogroup][@raid6,noexists][@raid31,exists] hide;show",
						["raidicon"] = {
							["attachTo"] = "TOPRIGHT",
							["xOffset"] = -2,
						},
			...
			["nameplates"] = {
				...
				["units"] = {
					["PLAYER"] = {
						...
						["health"] = {
							["text"] = {
								["format"] = "[healthcolor][health:current-percent]",
							},
							["useClassColor"] = false,
						},
						["power"] = {
					...
					["ENEMY_PLAYER"] = {
						...
						["health"] = {
							["height"] = 20,
							["text"] = {
								["format"] = "[health:current-percent:shortvalue]",
							},
						},
					},
					["ENEMY_NPC"] = {
